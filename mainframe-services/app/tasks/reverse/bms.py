...
class AnalyzedBMS(BaseModel):
    ...
    # @classmethod
    # def from_file_path(cls, file_path: str) -> "AnalyzedBMS":
    #     """
    #         Create a BMSBlob object from a file path.

    #         Args:
    #             file_path (str): The path to the file.

    #         Returns:
    #             BMSBlob: The BMSBlob object created from the file.
    #     """
    #     file_name = os.path.basename(file_path)
    #     content, encoding = read_content(file_path)
    #     content = re.sub(r'^\s*TITLE.*$', '', content,
    #                      flags=re.MULTILINE).strip()
    #     return cls(file_name=file_name, content=content, encoding=encoding)


# if __name__ == "__main__":
#     bms = AnalyzedBMS.from_file_path(
#         "../../DEMOLAB_SRC_FPTLT01/DEMO.CARDDEMO.BMS/COACTUP"
#     )
#     _ = bms.extract_data()
#     print(bms.overview)
#     print(bms.data)
