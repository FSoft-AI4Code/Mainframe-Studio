...
type Props = CommonProps & { setRepositoryId: (v: string) => void };

export const InputContent: React.FC<Props> = ({ data, isOnEdit, setIsOnEdit, setRepositoryId }) => {
