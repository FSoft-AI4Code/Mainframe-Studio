...
public class Cobol85PreprocessorLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"IDENTIFIER", "FILENAME", "NEWLINE", "COMMENTLINE", "COMMENTLINE_2", 
			"COMMENTLINE_3", "COMMENTLINE_4", "WS", "TEXT", "A", "B", "C", "D", "E", 
	...
	public Cobol85PreprocessorLexer(CharStream input) {
		super(input);
