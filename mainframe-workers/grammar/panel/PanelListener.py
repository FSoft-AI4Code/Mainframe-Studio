...
class PanelListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PanelParser#transDefaultOutput.
    def enterTransDefaultOutput(self, ctx:PanelParser.TransDefaultOutputContext):
        pass

    # Exit a parse tree produced by PanelParser#transDefaultOutput.
    def exitTransDefaultOutput(self, ctx:PanelParser.TransDefaultOutputContext):
        pass
