...
transFunc: TRANS LPAREN transParam (COMMACHAR transParam)* COMMACHAR transDefaultOutput RPAREN;

transDefaultOutput: STRINGLITERAL;

transParam: transVariable transReturn;
