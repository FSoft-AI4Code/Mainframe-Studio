...
public interface PanelListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PanelParser#transDefaultOutput}.
	 * @param ctx the parse tree
	 */
	void enterTransDefaultOutput(PanelParser.TransDefaultOutputContext ctx);
	/**
	 * Exit a parse tree produced by {@link PanelParser#transDefaultOutput}.
	 * @param ctx the parse tree
	 */
	void exitTransDefaultOutput(PanelParser.TransDefaultOutputContext ctx);
	/**
