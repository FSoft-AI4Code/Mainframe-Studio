...
class DaikyoUnisysCobolVistor(CobolUnisysVisitor):
    ...
    def __init__(self, parser: CobolUnisysParser):
        ...
        self.statements = []
        self.system_database_list: list[SystemDatabaseEntry] = []
        self.func = {
    ...
    def visitFileControlEntry(self, ctx: CobolUnisysParser.FileControlEntryContext):
        ...
        file_control_clause_list: List[CobolUnisysParser.FileControlClauseContext] = (
            ctx.fileControlClause()
        )

        assignment_name = None
        for file_control_clause in file_control_clause_list:
            assign_clause: CobolUnisysParser.AssignClauseContext = (
        ...
        access_mode_clause = recursive_find_first_child_by_type(
            ctx, CobolUnisysParser.AccessModeClauseContext
        )
        organization_clause = recursive_find_first_child_by_type(
            ctx, CobolUnisysParser.OrganizationClauseContext
        )
    ...
    def visitDataBaseSectionEntry(
        ...
        if ctx.dataBaseDatasetDeclare():
            ...
            self.system_database_list[-1].databases.append(
                DatabaseEntry(
    ...
    def visitOpenInputStatement(self, ctx: CobolUnisysParser.OpenInputStatementContext):
        open_input_list: List[CobolUnisysParser.OpenInputContext] = ctx.openInput()
        for open_input in open_input_list:
            file_control_name = recursive_find_first_child_by_type(
                open_input, CobolUnisysParser.FileNameContext
            )
    ...
    def visitOpenUpdateStatement(
        self, ctx: CobolUnisysParser.OpenUpdateStatementContext
    ):
        return self.visitChildren(ctx)
    ...
    def visitOpenOutputStatement(
        ...
        open_output_list: List[CobolUnisysParser.OpenOutputContext] = ctx.openOutput()

        for open_output in open_output_list:
            file_control_name = recursive_find_first_child_by_type(
                open_output, CobolUnisysParser.FileNameContext
            )
    ...
    def visitOpenIOStatement(self, ctx: CobolUnisysParser.OpenIOStatementContext):
        file_name_list: List[CobolUnisysParser.FileNameContext] = ctx.fileName()

        for file_name in file_name_list:
            file_control_name = recursive_find_first_child_by_type(
                file_name, CobolUnisysParser.FileNameContext
            )
