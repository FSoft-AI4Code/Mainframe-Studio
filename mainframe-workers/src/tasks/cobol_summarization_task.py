...
from llm.cobol_summarization import cobol_summary

class CobolSummarizationTask(BaseTask):
    def __init__(self):
    ...
    def execute(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        """Execute COBOL summarization task"""
        ...
        try:
            ...
            # Generate summary using cobol_summarization module
            summary = cobol_summary(program["paragraph_list"])

            # Save the summary
            save_result = self.reverse_controller.save_program_summary(
                name,
                repository_id, 
                summary,
                'COBOL'
            ...
            return {
                "status": "success",
                "message": "Successfully generated and saved program summary"
            }

        except Exception as e:
            logger.error("Error summarizing COBOL program", error=str(e))
            return {
                "status": "error", 
                "message": f"Error summarizing COBOL program: {str(e)}"
            }
