...
from parsers.grammar.common.cobol_statement_assessor import CobolStatementAssessor
...
class MyCobol85Visitor(Cobol85Visitor):
    ...
    def __init__(self, parser: Cobol85Parser):
        ...
        self.program_id = ""
        self.multi_layout_program: MultiLayoutProgram
        ...
        self.statements = []
        self.table_list: List[DatabaseTable] = []
    ...
    def visitFileControlEntry(self, ctx: Cobol85Parser.FileControlEntryContext):
        ...
        dataset_type = (
            "VSAM"
            if organization_type_text and organization_type_text.upper() != "SEQUENTIAL"
            else "FLAT"
        )
        ...
        file_control = FileControlEntry(
            ...
            organization=organization_type_text,
        )
    ...
    def visitExecSqlStatement2(self, ctx: Cobol85Parser.ExecSqlStatement2Context):
        ...
        if res:
            ...
            if isinstance(
                grandparent,
                (
                    Cobol85Parser.SentenceContext,
                    Cobol85Parser.DataDescriptionEntryContext,
                ),
            ):
                self.statements.append(res)
        return self.visitChildren(ctx)
