...
public class PanelParser extends Parser {
	...
	public static final int
		...
		RULE_transFunc = 96, RULE_variable_to_trans = 97, RULE_transParam = 98, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"transFunc", "variable_to_trans", "transParam", "transVariable", "transReturn", 
	...
	public static class TransFuncContext extends ParserRuleContext {
		...
		public TerminalNode LPAREN() { return getToken(PanelParser.LPAREN, 0); }
		public Variable_to_transContext variable_to_trans() {
			return getRuleContext(Variable_to_transContext.class,0);
		}
		public TerminalNode RPAREN() { return getToken(PanelParser.RPAREN, 0); }
	...
	@SuppressWarnings("CheckReturnValue")
	public static class Variable_to_transContext extends ParserRuleContext {
		public VariableContext variable() {
			return getRuleContext(VariableContext.class,0);
		}
		public Variable_to_transContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_variable_to_trans; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PanelListener ) ((PanelListener)listener).enterVariable_to_trans(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PanelListener ) ((PanelListener)listener).exitVariable_to_trans(this);
		}
	}

	public final Variable_to_transContext variable_to_trans() throws RecognitionException {
		Variable_to_transContext _localctx = new Variable_to_transContext(_ctx, getState());
		enterRule(_localctx, 194, RULE_variable_to_trans);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(747);
