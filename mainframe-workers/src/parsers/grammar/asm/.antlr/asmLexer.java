...
public class asmLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "A_CHAR", "B_CHAR", "C_CHAR", "D_CHAR", "N_CHAR", "O_CHAR", "L_CHAR", 
			"R_CHAR", "S_CHAR", "P_CHAR", "H_CHAR", "X_CHAR", "Y_CHAR", "Z_CHAR", 
			"V_CHAR", "F_CHAR", "LA", "LCR", "LH", "LHI", "LM", "LNR", "LPR", "LR", 
			"LTR", "AH", "AHI", "AL", "ALR", "AR", "CH", "CR", "CL", "CLC", "CLCL", 
			"CLI", "CLM", "CLR", "NC", "NI", "NR", "OC", "OI", "OR", "SLA", "SLDA", 
			"SLDL", "SLL", "SRA", "SRDA", "SRL", "TM", "XC", "XI", "XR", "BAL", "BALR", 
			"BAS", "BASR", "BC", "BCR", "BCT", "BCTR", "BXH", "BXLE", "AP", "CP", 
			"CVP", "CVD", "DP", "ED", "EDMK", "MP", "MVN", "MVO", "MVZ", "PACK", 
			"SP", "SRP", "UNPK", "ZAP", "CS", "CDS", "EX", "STCK", "SVC", "TR", "TRT", 
			"TS", "AMODE", "CSECT", "DC", "DSECT", "DROP", "EJECT", "END", "EQU", 
			"LTORG", "ORG", "POP", "PRINT", "PUSH", "RMODE", "SPACE", "TITLE", "USING", 
			"ABEND", "CALL", "CLOSE", "DCB", "GET", "OPEN", "PUT", "RETURN", "SAVE", 
			"STORAGE", "YREGS", "WTO", "EXTRACT", "DISPLAY", "CNOP", "DB", "FD", 
			"GR", "MVC", "MVCL", "MVI", "ST", "STC", "STCM", "STH", "STM", "IC", 
			"ICM", "COMP", "BE", "MOVE", "WRITE", "BH", "BO", "BL", "BNE", "BR", 
			"BZ", "BNL", "SLR", "SR", "MH", "DS", "AND", "START", "GETMAIN", "LV", 
			"VL", "DOT", "COMMA", "LP", "RP", "PLUS", "MINUS", "EQUAL", "ASTERISK", 
			...
			"EOL", "WS", "SPECIAL_CHAR", "DC_CONSTANT", "A", "B", "C", "D", "E", 
