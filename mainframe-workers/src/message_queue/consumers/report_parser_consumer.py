...
from tasks.report_parser_task import ReportParserTask
import structlog

logger = structlog.get_logger()

class ReportParserConsumer(BaseConsumer):
    def __init__(self):
        super().__init__(
            queue_config=settings.QUEUE_CONFIGS["report_tasks"],
        )
        self.task_factory.register_task("parse_report", ReportParserTask)
