...
from tasks.panel_parser_task import PanelParserTask
import structlog

logger = structlog.get_logger()

class PanelParserConsumer(BaseConsumer):
    def __init__(self):
        super().__init__(
            queue_config=settings.QUEUE_CONFIGS["panel_tasks"],
        )
        self.task_factory.register_task("parse_panel", PanelParserTask)
